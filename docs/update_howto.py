...
SKIP_FOLDER = ['Ernoult-Chabassier-Rodriguez_Humeau_2021', 'Thibault-Chabassier_JASA2020',
               ...
               'RR-humidity_Ernoult_2023', 'Thibault_Thesis2023', 'Besson_simulations']
...
def main():
    ...
    for filepath in filepath_list:
        ...
        if os.path.exists(output) and force_flag == False:
            ...
            #     f.write(rst_content)
            #     f.close()
            rst_content = pypandoc.convert_text(' '.join(file_content), 'rst', format='md', outputfile=output)
...
def parse_example(filepath):
    ...
    for line in lines:
        ...
        # if not (line.startswith('"""') or line.endswith('"""') or docstring.find(line)!=-1):
