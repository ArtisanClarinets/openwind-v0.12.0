...
alpha = 2.0 # THE ALPHA COEFFICIENT TO USE IN ZK-HR
...
rec = simulate(duration,
               ...
               holes,
               player=player,
                losses=f"diffrepr8 {alpha}",  # ENABLE VISCOTHERMAL LOSSES WITH ZK-HR MODEL
               temperature=20,
               l_ele=0.01,
...
anim = SimuAnimation(ig, rec, name=f"simu_ZKHR_alpha{alpha:g}")
